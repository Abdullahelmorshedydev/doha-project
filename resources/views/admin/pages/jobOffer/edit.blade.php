...
@section('contentHeader', 'Edit Job Offer')

@section('contentHeaderLink')
    <a href="{{ route('admin.job-offers.index') }}">All</a>
@endsection

@section('contentHeaderActive', 'Edit Job Offer')
                ...
                <form action="{{ route('admin.job-offers.update', $jobOffer->id) }}" method="POST">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" value="{{ old('name', $jobOffer->name) }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="link" value="{{ old('link', $jobOffer->link) }}"
